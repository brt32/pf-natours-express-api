...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      set: (val) => Math.round(val * 10).toFixed(2) / 10,
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        // normal function, need this keyword
...
// Virtual Populate, connecting tour with reviews without persisting
...
// DOCUMENT MIDDLEWARE: runs only before the .save() and .create() not .insertMany
